...
const servicesData: ServiceItem[] = [
  ...
  },
  {
    ...
    description:
      "Empower your corporate gatherings with high-tech stages, interactive LED backdrops, crystal-clear spatial sound, and seamless live-streaming setups. We ensure your brand message is delivered with absolute precision.",
  ...
  },
  {
    ...
    description:
      "We produce stadium-scale music festivals and live concerts. Our team manages line-ups, security, ticketing integration, line-array audio systems, and synchronized laser shows that leave the crowd mesmerized.",
  ...
  },
  {
    ...
    description:
      "Acoustics and intimacy are key to stage performances. We design seating layouts and fine-tune sound systems so that every punchline, note, and whisper is clearly heard by the audience.",
  ...
  },
  {
    ...
    description:
      "Birthdays, anniversaries, and milestone events deserve more than ordinary. We curate immersive themed experiences with custom props, live entertainment, and luxury catering that make every occasion unforgettable.",
  ...
  },
  {
    ...
    category: "social",
    image: "/images/themed_party.jpg",
    tagline: "Transport your guests to another world.",
    description:
      "From neon retro nights and masquerade balls to Gatsby galas, we bring extraordinary themes to life with meticulously crafted decor, costumes, live acts, and bespoke audio-visual setups.",
    features: ["Fantasy & Costume Themes", "Custom Prop Design", "Live Acts & Performers", "Holographic Displays"],
  ...
  },
  {
    ...
    description:
      "Launch your product or cultural performance with maximum impact. We design experiential booths, holographic display cases, theatrical reveal sequences, and cultural stage shows that captivate both media and audiences.",
    features: ["Holographic Reveal Pods", "Interactive Experience Booths", "Media & Press Conference Setup", "Cultural Stage Productions"],
    capacity: "100 – 2000+ Guests",
    icon: <Users size={22} />,
  },
];
...
export default function ServicesPage() {
  ...
  const filtered = servicesData.filter((s) => activeTab === "all" || s.category === activeTab);
  ...
  return (
    <div className="relative min-h-screen bg-[#030712] text-white overflow-hidden font-sans pb-24">
      ...
      <div className="absolute top-[10%] right-[-10%] w-[55%] h-[55%] rounded-full bg-indigo-900/10 blur-[160px] pointer-events-none z-0" />
      <div className="absolute bottom-[15%] left-[-10%] w-[55%] h-[55%] rounded-full bg-sky-900/10 blur-[160px] pointer-events-none z-0" />

      {/* HERO */}
      <section className="relative z-10 pt-32 pb-4 px-6 sm:px-12 md:px-20 lg:px-24 text-center max-w-5xl mx-auto flex flex-col items-center">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md text-sky-400 text-xs font-semibold tracking-widest uppercase mb-6">
          <Sparkles size={14} /> What We Offer
        </div>
        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight leading-[1.1] mb-6">
          World-Class Events For<br />
        ...
        <p className="text-gray-400 text-lg md:text-xl max-w-3xl leading-relaxed mb-12">
          From royal weddings and electrifying concerts to premium corporate summits and themed galas — we plan, produce, and execute events that set new global standards.
        </p>
          ...
          {filtered.map((service) => (
            ...
            >
              ...
              <div className="relative w-full aspect-[16/10] overflow-hidden">
                ...
                <div className="absolute top-4 right-4 z-20 w-10 h-10 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-sky-400">
                  {service.icon}
                </div>
              </div>
              ...
              <div className="p-8 flex-grow flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sky-400 text-sm font-medium italic mb-4">{service.tagline}</p>
                  <p className="text-gray-400 text-sm sm:text-base leading-relaxed mb-6">{service.description}</p>
                ...
                <div className="border-t border-white/5 pt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  <div className="flex items-center gap-2 text-xs text-gray-400">
                    ...
                    <span>Capacity: <strong className="text-white">{service.capacity}</strong></span>
                  </div>
                  <Link
      ...
      {/* STATS */}
      <section className="relative z-10 mt-28 px-6 sm:px-12 md:px-20 lg:px-24 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-12 bg-white/[0.02] border border-white/10 rounded-3xl backdrop-blur-md text-center">
          <div className="flex flex-col items-center">
            <div className="w-12 h-12 rounded-2xl bg-sky-500/10 flex items-center justify-center text-sky-400 mb-4"><Award size={24} /></div>
          ...
          <div className="flex flex-col items-center border-y md:border-y-0 md:border-x border-white/15 py-8 md:py-0">
            <div className="w-12 h-12 rounded-2xl bg-indigo-500/10 flex items-center justify-center text-indigo-400 mb-4"><Users size={24} /></div>
            <h4 className="text-3xl font-black text-white mb-2">10k+</h4>
            <p className="text-gray-500 text-sm">Attendees Entertained</p>
          </div>
          <div className="flex flex-col items-center">
            <div className="w-12 h-12 rounded-2xl bg-purple-500/10 flex items-center justify-center text-purple-400 mb-4"><Shield size={24} /></div>
      ...
      {/* CTA */}
      <section className="relative z-10 mt-28 px-6 sm:px-12 md:px-20 lg:px-24 max-w-5xl mx-auto text-center bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-white/10 rounded-3xl p-12 sm:p-16">
        <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">Have a Special Concept in Mind?</h2>
        <p className="text-gray-300 text-base sm:text-lg max-w-2xl mx-auto mb-8">
          We love custom themes and challenging integrations. Speak directly with our lead creative producers and bring your dream event to life.
        </p>
        <Link
          href="/contact"
