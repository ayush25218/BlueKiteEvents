    ...
    <div className="relative min-h-screen bg-[#030712] text-white overflow-hidden font-sans pb-24">
      ...
      <section className="relative z-10 px-6 sm:px-12 md:px-20 lg:px-24 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-6 items-center">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-wider font-semibold">Scale</p>
                  <p className="text-white font-bold text-sm sm:text-base">{service.capacity}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-400 uppercase tracking-wider font-semibold">Planning Time</p>
                  <p className="text-white font-bold text-sm sm:text-base">{service.turnaround}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative aspect-[4/3] rounded-3xl overflow-hidden border border-white/10 shadow-2xl group">
            <Image src={service.image} alt={service.title} fill sizes="(max-width: 768px) 100vw, 50vw" priority className="object-cover transition-transform duration-700 group-hover:scale-105" />
      ...
      <section className="relative z-10 mt-24 px-6 sm:px-12 md:px-20 lg:px-24 max-w-7xl mx-auto">
        <h2 className="text-2xl sm:text-3xl font-bold text-white mb-8 text-center sm:text-left">
          Key <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-indigo-400">Features</span>
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {service.features.map((feat, i) => (
            <div
              key={i}
              className="flex items-start gap-4 p-6 rounded-2xl bg-white/[0.02] border border-white/5 hover:border-white/10 transition-all duration-300"
            >
              <CheckCircle className="text-emerald-400 mt-1 flex-shrink-0" size={20} />
              <div>
                <h3 className="text-white font-bold text-base mb-1">{feat}</h3>
                <p className="text-gray-400 text-sm">We coordinate high-quality setups and delivery to execute flawlessly.</p>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* PROCESS */}
      <section className="relative z-10 mt-24 px-6 sm:px-12 md:px-20 lg:px-24 max-w-7xl mx-auto bg-white/[0.01] border border-white/5 rounded-3xl p-8 sm:p-12">
        <h2 className="text-2xl sm:text-3xl font-bold text-white mb-12 text-center">
          Our Execution <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-indigo-400">Workflow</span>
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
          {service.process.map((step, i) => (
            <div key={i} className="relative flex flex-col items-center md:items-start text-center md:text-left group">
              {/* Step Number Badge */}
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-sky-500 to-indigo-600 flex items-center justify-center font-black text-white text-lg shadow-lg mb-4 relative z-10">
                0{i + 1}
              </div>
              <h3 className="text-white font-bold text-lg mb-2">{step.step}</h3>
