...
const galleryData: GalleryItem[] = [
  ...
  },
  {
    ...
    title: "Live Concerts",
    category: "concert",
    src: "/images/music_concert.jpg",
    tag: "Concert",
    description: "A big stadium concert with amazing laser light shows.",
  },
  {
    id: "g4",
    title: "Theme Party",
    category: "party",
    src: "/images/themed_party.jpg",
    tag: "Party",
    description: "An anniversary party decorated with bright neon lights.",
  },
  {
    id: "g5",
    ...
    tag: "Corporate",
    description: "A stage for business meetings with large LED screens.",
  },
  {
    id: "g6",
    title: "Comedy Show",
    category: "concert",
    src: "/images/comedy_show.jpg",
    tag: "Stage Show",
    description: "A great stage setup with good sound for a comedy show.",
  },
];
