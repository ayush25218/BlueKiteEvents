...
const galleryData: GalleryItem[] = [
  ...
  },
  {
    ...
    tag: "Stage Show",
    description: "Acoustically optimized venue for a national comedy tour.",
  },
  {
    id: "g7",
    title: "Interactive Product Unveil",
    category: "corporate",
    src: "/images/stage_show.png",
    tag: "Product Launch",
    description: "Theatrical reveal sequence using custom automated lighting rigs.",
  },
  {
    id: "g8",
    title: "Behind The Curtains",
    category: "concert",
    src: "/images/event_director.png",
    tag: "Production",
    description: "Our core production crew managing the live DMX console.",
  },
  {
    id: "g9",
    ...
    tag: "Conference",
    description: "An elegant auditorium setup for a large-scale corporate business summit.",
  },
  {
    id: "g10",
    title: "Elite Gala Banquet",
    category: "party",
    src: "/images/gallery/gallery_gala_1.png",
    tag: "Gala Dinner",
    description: "Bespoke tablescapes and ambient lighting for a high-end corporate gala dinner.",
  },
  {
    id: "g11",
    title: "Traditional Sangeet Celebration",
    category: "wedding",
    src: "/images/gallery/gallery_wedding_1.jpg",
    tag: "Sangeet",
    description: "Vibrant traditional decor and high-energy performances at a grand Sangeet celebration.",
  },
  {
    id: "g12",
  ...
  {
    id: "g13",
    title: "Keynote Address Presentation",
    category: "corporate",
    src: "/images/gallery/gallery_speaker_1.png",
    tag: "Summit",
    description: "Integrated LED walls and professional acoustics for a keynote speaker session.",
  },
  {
    id: "g14",
    ...
    tag: "Cocktail",
    description: "Bespoke bar setup with metallic disco installations and mood lighting for an elite celebration.",
  },
];
